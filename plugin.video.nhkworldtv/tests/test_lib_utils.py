...
def test_get_news_program_play_path():
    xmltext = "rtmp://flv.nhk.or.jp/ondemand/flv/nhkworld/upld/medias/en/news/programs/1001_20220908132010.mp4"
    assert utils.get_news_program_play_path(xmltext) == "1001_20220908132010"
