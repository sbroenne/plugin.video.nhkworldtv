...
class Test_Test_Navigation_Menus(unittest.TestCase):
    def test_main_menu(self):
        self.assertTrue(main.add_directory_main_menu())
    
    def test_vod_menu(self):
        self.assertTrue(main.add_directory_vod_menu())

class Test_Test_Livestream(unittest.TestCase):

    def test_add_live_stream(self):
        
        self.assertTrue(main.add_live_stream)

class Test_Test_VOD_Menus(unittest.TestCase):

    def test_get_programs(self):
        detail_url = main.add_directory_vod_programs()
        #print(detail_url)
        self.assertIsNotNone(detail_url)
    
    def test_get_categories(self):
        detail_url = main.add_directory_vod_categories()
        #print(detail_url)
        self.assertIsNotNone(detail_url)

    def test_get_playlists(self):
        detail_url = main.add_directory_vod_playlists()
        #print(detail_url)
        self.assertIsNotNone(detail_url)
...
class Test_Test_VOD_Episode_List(unittest.TestCase):
    ...
    def test_get_programs_episodelist(self):
        ...
        vid_id = main.add_directory_vod_episode_list(test_url, True, False)
        #print(vid_id)
    ...
    def test_get_categories_episodes(self):
        ...
        vid_id = main.add_directory_vod_episode_list(test_url, False, False)
        #print(vid_id)
        self.assertIsNotNone(vid_id)
    ...
    def test_get_playlists_episodes(self):
        ...
        vid_id = main.add_directory_vod_episode_list(test_url, False, True)
        #print(vid_id)
        self.assertIsNotNone(vid_id)
...
class Test_Test_VOD_Episode_Play(unittest.TestCase):
    ...
    def test_show_episode(self):
        ...
        episode_url = main.show_episode(  'UnitTest Episode', 
